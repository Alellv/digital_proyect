...
#-----------------------------------------------------------------------------------------BCD A BINARIO
COMM_OBJS+= calculadora/bcd_binario/bcd2bin_top.v 
COMM_OBJS+= calculadora/bcd_binario/bcd_sub_block.v 
...
#-----------------------------------------------------------------------------------------BCD A BINARIO
COMM_OBJS+= calculadora/sqrt/perip_sqrt.v 
COMM_OBJS+= calculadora/sqrt/sqrt.v 
