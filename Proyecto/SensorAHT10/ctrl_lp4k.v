module ctrl_lp4k(
 ...
 parameter GET_PIXEL   = 4'b0110;
 parameter INC_COL     = 4'b0111;
 parameter ROW_READY   = 4'b1000;
 parameter SEND_ROW    = 4'b1001;
 parameter DELAY_ROW   = 4'b1010;
 parameter INC_ROW     = 4'b1011;
 parameter READY_FRAME = 4'b1100;
 parameter NEXT_BIT    = 4'b1101;
 parameter NEXT_DELAY  = 4'b1110;
