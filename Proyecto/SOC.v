...
module SOC (
   ...
   wire [31:0] uart_dout;
   wire [31:0] Led_panel_12bpp_dout;
   wire [31:0] i2c_dout;
...
//     .clk_freq(27000000),  // for nano_20k
   ...
   peripheral_led_panel led_panel1 ( //-------------------------MULTIPLICADOR
      .clk(clk),
      .reset(!resetn),
      .d_in(mem_wdata[15:0]),
      .cs(cs[3]),
  ...
  begin
      case (mem_addr[31:16])	// direcciones - chip_select
        ...
        16'h0042: cs= 8'b00001000; //pantalla
        16'h0043: cs= 8'b00000100; //sensor
...
//        7'b1000000: mem_rdata = dpram_dout;
        ...
        8'b00001000: mem_rdata = Led_panel_12bpp_dout;
        8'b00000100: mem_rdata = i2c_dout;
