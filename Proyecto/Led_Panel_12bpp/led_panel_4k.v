module led_panel_4k(clk , rst , init, LP_CLK, LATCH, NOE, ROW, RGB0, RGB1, I1, I2, I3);
...
reg [4:0] clk_counter;
   always @(posedge clk) begin
    ...
    compg #(.width(5) ) compT1(.in1(T), .in2(6'b100011), .out(w_ZT1));
    compg #(.width(5) ) compT2(.in1(T), .in2(6'b011001), .out(w_ZT2));
    memory  #(.size(NUM_PIXELS/2 -1), .width( $clog2(NUM_PIXELS)-2 ) ) mem0 (.clk(clk1), .address(PIX_ADDR), .I1(I1), .I2(I2), .I3(I3), .rdata(mem_data));
